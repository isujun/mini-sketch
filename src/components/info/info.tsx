    ...
    <div>
      ...
      >
        ...
        <div className="infoContent">
          <p>Welcome to Mini-Sketch! Get started with these simple steps:</p>
          <ul>
            <li>
              <strong>Choose a Tool:</strong> Select from pencil, line,
              rectangle, circle, or text tools to start drawing.
            </li>
            <li>
